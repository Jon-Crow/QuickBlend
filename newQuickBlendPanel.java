...
public class QuickBlendPanel extends JPanel implements ActionListener, Updateable, Initializable, Saveable
{
    ...
    private JButton blendBtn, blendListBtn, addBtn;
    private JMenuItem dbBtn, editDbBtn, reloadBtn;
    ...
    public QuickBlendPanel()
    {
        ...
        dbMenu.add(dbBtn = new JMenuItem("Open Database Spreadsheet"));
        dbMenu.add(editDbBtn = new JMenuItem("Edit Database"));
        dbMenu.add(reloadBtn = new JMenuItem("Reload"));
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        else if(event.getSource() == reloadBtn)
        {
            updateComponents(BlendComponent.loadDatabase(DATABASE_FILE.getAbsolutePath()));
        }
