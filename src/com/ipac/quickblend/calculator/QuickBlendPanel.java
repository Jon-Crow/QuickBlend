...
public class QuickBlendPanel extends JPanel implements ActionListener, Updateable, Initializable, Saveable
{
    ...
    private static JInternalFrame dbFrame;
    private JInternalFrame blendsFrame, resFrame;
    ...
    public QuickBlendPanel()
    {
        ...
        add((dbBtn = new JButton("Open database.csv")),"span 3,left");
    ...
    */
    ...
    public static boolean invalidComponents()
    {
        return !COMPONENTS[0].isValid();
    }
    public static void openDatabaseEditor()
    {
        if(dbFrame != null && dbFrame.isVisible())
        {
            dbFrame.toFront();
            return;
        }
        dbFrame = Main.addPanel(new DatabaseEditor2(), "Database");
        //dbFrame = Main.addPanel(new DatabaseSheet(), "Database");
    }
}